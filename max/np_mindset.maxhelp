...
, 			{
				"box" : 				{
					...
					"id" : "obj-13",
					"fontname" : "Arial",
					"patching_rect" : [ 74.0, 140.0, 133.0, 18.0 ],
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontsize" : 10.0
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-12",
					"fontname" : "Arial",
					"patching_rect" : [ 76.0, 93.0, 133.0, 41.0 ],
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontsize" : 10.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Close the Mindset, assuming it's open",
					"linecount" : 2,
					"id" : "obj-11",
					"fontname" : "Arial",
					"patching_rect" : [ 81.0, 50.0, 133.0, 29.0 ],
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontsize" : 10.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Open the Mindset. Takes a port name. May block a bit.",
					"linecount" : 2,
					"id" : "obj-1",
					"fontname" : "Arial",
					"patching_rect" : [ 175.0, 11.0, 133.0, 29.0 ],
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontsize" : 10.0
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-6",
					"fontname" : "Arial",
					"patching_rect" : [ 41.0, 50.0, 39.0, 18.0 ],
					"numinlets" : 2,
					"numoutlets" : 1,
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "open /dev/tty.MindSet-DevB",
					"outlettype" : [ "" ],
					"id" : "obj-5",
					"fontname" : "Arial",
					"patching_rect" : [ 13.0, 11.0, 159.0, 18.0 ],
					"numinlets" : 2,
					"numoutlets" : 1,
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-4",
					"fontname" : "Arial",
					"patching_rect" : [ 41.0, 141.0, 33.0, 18.0 ],
					"numinlets" : 2,
					"numoutlets" : 1,
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-3",
					"fontname" : "Arial",
					"patching_rect" : [ 41.0, 95.0, 34.0, 18.0 ],
					"numinlets" : 2,
					"numoutlets" : 1,
					"fontsize" : 12.0
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 50.5, 173.0, 22.5, 173.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 50.5, 121.0, 22.5, 121.0 ]
				}
